// Pięć przycisków z napisami "Przycisk 1" - "Przycisk 5" pokazać w oknie przy użyciu różnych menedżerów rozkładu.
// Rozkład ma być wybierany na starcie aplikacji - np. w dialogu wejściowym.
