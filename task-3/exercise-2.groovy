// Firma software'owa prowadzi projekty w: Groovy, Grails, Java, JEE
...
keys.each { key ->
    ...
    println "Projekt $key zatrudnia $count"
}

// Zadanie b
def moreThanTwoProgrammers = pmap.findAll {
    it.value.size() > 2
}
println moreThanTwoProgrammers
